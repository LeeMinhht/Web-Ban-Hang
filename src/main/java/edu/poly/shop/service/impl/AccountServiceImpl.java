...
public class AccountServiceImpl implements AccountService{
	...
	public Account login(String username,String password) {
		Optional<Account> optExitst = findById(username);
		
		if(optExitst.isPresent() && password.equals(optExitst.get().getPassword())) {
			optExitst.get().setPassword("");
			return optExitst.get();
		}
		return null;
	...
	public <S extends Account> S save(S entity) {
		...
		if(optExist.isPresent()) {
			if(StringUtils.isEmpty(optExist.get().getPassword())) {
